...
def build_bond_list(coordinates, max_bond=2.93, min_bond=0):
	...
	The maximum distance between atoms to be cponsidered a bond. Default is 2.93 bohr
    ...
    -------
    bonds : dict
	A dictionary of bonds with atom pair tuples as keys, and calculated bold lengths as values
    """
